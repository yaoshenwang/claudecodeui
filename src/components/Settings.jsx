...
import { X, Plus, Settings as SettingsIcon, Shield, AlertTriangle, Moon, Sun, Server, Edit3, Trash2, Globe, Terminal, Zap, FolderOpen, LogIn, Key, GitBranch, Check, FileText } from 'lucide-react';
...
function Settings({ isOpen, onClose, projects = [], initialTab = 'agents' }) {
  ...
  const [selectedCategory, setSelectedCategory] = useState('account'); // 'account', 'permissions', 'mcp', 'provider', 'mcp-manager', 'prompts'
